...
public class BookDTO {
    ...
    public BookDTO(String id, String newTitle, String nweAuthor, String newField, String newLanguage, String newEdition,
                   String newDescription, String newPublishingCompany, String newState, String createdAt) {
        this.id = id;
        this.name = newTitle;
    ...
    public static Book returnBook(BookDTO bookDTO) {
        return new Book(Long.parseLong(bookDTO.getId()), bookDTO.getName(), bookDTO.getAuthor(), bookDTO.getCategory(), bookDTO.getLanguage(),
                bookDTO.getYear(), bookDTO.getDescription(), bookDTO.getPublishingCompany(),
                bookDTO.getState(), bookDTO.getUser().getEmail(),
